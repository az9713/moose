...
### Cases 45-48: Stochastic Tools & Optimization

Drawn from Smith, *Uncertainty Quantification* (SIAM, 2014). These cases introduce MOOSE's `stochastic_tools` and `optimization` modules — Monte Carlo sampling, polynomial chaos surrogates, adjoint-based optimization, and Latin Hypercube parameter studies.

<table>
<tr>
<td align="center"><img src="quickstart-runs/case45-monte-carlo-uq/case45_monte_carlo_uq.png" width="220"/><br/><sub>Case 45: Monte Carlo UQ</sub></td>
