...
| [Quick Start](docs/quick-start.md) | 73 progressive worked examples — from 1D diffusion to chemical reactions, mortar contact, XFEM, THM pipe flow, and level-set advection | Everyone |
