...
| [Quick Start](docs/quick-start.md) | 48 progressive worked examples — from 1D diffusion to stochastic tools and optimization, with complete input files | Everyone |
