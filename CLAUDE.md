...
| [Quick Start](docs/quick-start.md) | 103 progressive worked examples — from 1D diffusion to chemical reactions, mortar contact, XFEM, THM pipe flow, level-set advection, advanced electromagnetism, antennas, inverse estimation, and continuum electromechanics | Everyone |
